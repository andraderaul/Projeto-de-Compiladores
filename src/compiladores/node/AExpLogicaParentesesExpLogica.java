...
public final class AExpLogicaParentesesExpLogica extends PExpLogica
{
    private TAParentese _aParentese_;
    private PExpLogica _expLogica_;
    private TFParentese _fParentese_;

    public AExpLogicaParentesesExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpLogicaParentesesExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpLogicaParentesesExpLogica(this);
    }
