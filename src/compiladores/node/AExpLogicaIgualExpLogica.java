...
public final class AExpLogicaIgualExpLogica extends PExpLogica
{
    private PExp _exp_;
    private TIgual _igual_;
    private PExpAux _expAux_;

    public AExpLogicaIgualExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpLogicaIgualExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpLogicaIgualExpLogica(this);
    }
