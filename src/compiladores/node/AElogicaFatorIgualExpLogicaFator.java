...
public final class AElogicaFatorIgualExpLogicaFator extends PExpLogicaFator
{
    private PExp _exp_;
    private TIgual _igual_;
    private PTermo _termo_;

    public AElogicaFatorIgualExpLogicaFator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AElogicaFatorIgualExpLogicaFator(
    ...
    {
        ((Analysis) sw).caseAElogicaFatorIgualExpLogicaFator(this);
    }
