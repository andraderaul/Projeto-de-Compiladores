...
public final class AComandoListComandoList extends PComandoList
{
    private final LinkedList<PComandos> _comandos_ = new LinkedList<PComandos>();

    public AComandoListComandoList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoListComandoList(
    ...
    {
        ((Analysis) sw).caseAComandoListComandoList(this);
    }
