...
public final class AComandoLeiaComandos extends PComandos
{
    ...
    public Object clone()
    {
        return new AComandoLeiaComandos(
    ...
    {
        ((Analysis) sw).caseAComandoLeiaComandos(this);
    }
